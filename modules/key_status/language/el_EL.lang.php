...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'status Λίστα',
  'LBL_MODULE_NAME' => 'status',
  'LBL_MODULE_TITLE' => 'status',
  'LBL_MODULE_NAME_SINGULAR' => 'status',
  'LBL_HOMEPAGE_TITLE' => 'Δική Μου status',
  'LNK_NEW_RECORD' => 'Δημιουργία status',
  'LNK_LIST' => 'Προβολή status',
  'LNK_IMPORT_KEY_STATUS' => 'Import status',
  'LBL_SEARCH_FORM_TITLE' => 'Αναζήτηση status',
