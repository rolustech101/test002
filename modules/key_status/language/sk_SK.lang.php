...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'status Zoznam',
  'LBL_MODULE_NAME' => 'status',
  'LBL_MODULE_TITLE' => 'status',
  'LBL_MODULE_NAME_SINGULAR' => 'status',
  'LBL_HOMEPAGE_TITLE' => 'Moje status',
  'LNK_NEW_RECORD' => 'Vytvoriť status',
  'LNK_LIST' => 'zobrazenie status',
  'LNK_IMPORT_KEY_STATUS' => 'Import status',
  'LBL_SEARCH_FORM_TITLE' => 'Vyhľadávanie status',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Zobraziť Históriu',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Aktivity',
  'LBL_KEY_STATUS_SUBPANEL_TITLE' => 'status',
  'LBL_NEW_FORM_TITLE' => 'Nový status',
  'LNK_IMPORT_VCARD' => 'Import status vCard',
  'LBL_IMPORT' => 'Import status',
  'LBL_IMPORT_VCARDTEXT' => 'Automatically create a new status record by importing a vCard from your file system.',
  'LBL_STATUS' => 'status',
);