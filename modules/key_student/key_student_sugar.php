 ...
 * PLACE ANY CUSTOMIZATIONS IN key_student
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class key_student_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'key_student';
    public $object_name = 'key_student';
    public $table_name = 'key_student';
     ...
     */
    public function key_student_sugar()
    {
        self::__construct();
    }
